...
\tadOperacion{armameUnaSinVal}{tabla $\quad$ t, campo $\quad$ c, nat $\quad$ n, conj(registro) $\quad$ rs}{tabla}{tipo($c$)=Nat}

\tadOperacion{armameUnaSinPal}{tabla $\quad$ t, campo $\quad$ c, string $\quad$ s, conj(registro) $\quad$ rs}{tabla}{tipo($c$)=String}

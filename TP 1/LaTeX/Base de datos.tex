...
\tadOperacion{\#Modificaciones}{tabla  $\quad$ $t_1$, bdd  $\quad$ $b$}{nat}{$t_1$ $\in$ tablas($b$}
...
\tadOperacion{ElimTrigger}{tabla $\quad$ $t_1$ ,tabla $\quad$ $t_2$ ,bdd $\quad$ $b$}{bdd}{$t_2$ $\in$ QueTriggerea?($t_1$,b)}

\tadOperacion{AgregarReg}{ reg $r$, tabla $\quad$ $t_1$ ,bdd $\quad$ $b$}{bdd}{$t_1$ $\in$ tablas($b$)}

\tadOperacion{ElimRegStr}{campo $\quad$ $c$ ,string $\quad$ $s$,tabla $\quad$ $t_1$, bdd $b$}{bdd}{$\neg$(Nat?(tipo($c$) $\wedge$ $t_1$ $\in$ tablas($b$)}

\tadOperacion{ElimRegNat}{campo $\quad$ $c$ ,nat $\quad$ $n$,tabla $\quad$ $t_1$ , bdd $b$}{bdd}{(Nat?(tipo($c$) $\wedge$ $t_1$ $\in$ tablas($b$)}
